<script type="application/javascript">
    $("body").on('submit', '#frm-user-contact-email', function (event) {
        event.preventDefault()
        if ($('#frm-user-contact-email').valid()) {

            var formData = new FormData(document.getElementById("frm-user-contact-email"));
            ...
            $.ajax({
                ...
                type: "POST",
                url: "{{route('save.service.requests')}}",
                cache: false,
                contentType: false,
                processData: false,
                dataType: 'json',
