            ...
            <div class="col-12">
                <div class="card card-purple card-outline">
                    ...
                    <form role="form">
                        ...
                        @include('layouts.button-from-table', ['route_cancel' => route('get.client.subscription'), 'new'=>false])
                    </form>
                </div>
            </div>
        </div>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    @if($showButtonPay)
                                                        <a class="dropdown-item edit_form" data-id="{{$item->subscription_id}}" data-url="{{route('form.verify.pay.subscription')}}">Verificar Pago</a>
                                                        <a class="dropdown-item confirm_action" href="javascript:void(0)" data-id="{{$item->subscription_id}}" data-name="{{route('user.destroy')}}">Eliminar</a>
                                                    @else
                                                        <a class="dropdown-item confirm_action" href="javascript:void(0)" data-id="{{$item->subscription_id}}" data-name="{{route('user.destroy')}}">Eliminar</a>
                                                    @endif()
...
@section('script')
    @include('admin.global_script.function-form-modal')
    @include('admin.user.function-verify-pay')
@endsection
