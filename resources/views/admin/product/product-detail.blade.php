...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="mt-3">
                                ...
                                @if($rolAdmin || $rolSeller)
                                    ...
                                    @else
                                        / <span class="badge badge-danger p-2">
                                        <i class="fas fa-times-circle mr-1"></i> Por aprobar
                                    </span>
                                    @endif
                                @endif
                            </div>
                    ...
                    <div class="card card-purple card-outline shadow mt-3">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                @if($rolCustomer)
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="{{route('product.shopping', ['id' =>encrypt($product->id), 'back' =>encrypt($routeBack)])}}" class="btn btn-block btn-outline-success">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        @if(!$product->is_approved)
                                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12">
                                                <button type="button" class="btn btn-block btn-outline-success confirm_action" data-id="{{$product->id}}" data-name="{{route('approve.product', ['approve' =>true])}}">
                                                    <i class="fas fa-check-circle"></i> Aprobar producto
                                                </button>
                                            </div>

                                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12">
                                                <button type="button" class="btn btn-block btn-outline-danger confirm_action" data-id="{{$product->id}}" data-name="{{route('approve.product', ['approve' =>false])}}">
                                                    <i class="fas fa-times"></i> No aprobar
                                                </button>
                                            </div>
                                        @else
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-purple card-outline shadow mt-3">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-chart-bar mr-2"></i>Estadísticas Rápidas
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
            ...
            @include('admin.product.related-product', ['routeBack' =>$routeBack])
        </div>
    </section>
@endsection
